    ...
    <nav class="navbar mynav navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><img src="Ethereal/images/logoernesto.png" id="img-blanco" alt="" style="height: 50px; margin: -15px;"></a>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10">
          <div id="owl-demo" class="owl-carousel owl-theme test">
            <div class="item">
              <p><sup><i class="fa fa-quote-left"></i></sup>Excelentes profesionales<sup><i class="fa fa-quote-right"></i></sup></p>
              <div class="test-img"> <img src="images/team-img-01.jpg" />
                <p><strong>Leo Caceres</strong></p>
              </div>
            </div>
            <div class="item">
              <p><sup><i class="fa fa-quote-left"></i></sup>Gracias. He incrementado las ventas<sup><i class="fa fa-quote-right"></i></sup></p>
              <div class="test-img"> <img src="images/team-img-02.jpg" />
                <p><strong>Ramiro Mairena</strong></p>
              </div>
            </div>
            <div class="item">
              <p><sup><i class="fa fa-quote-left"></i></sup>100% recomendado<sup><i class="fa fa-quote-right"></i></sup></p>
              <div class="test-img"> <img src="images/team-img-03.jpg" />
                <p><strong>Fabiola Pérez</strong></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-8 col-sm-10">
            <div class="subscribe-text">
              <h3>Síguenos en facebook para ver nuestras actualizaciones</h3>
              <p>Únete a nuestra comunidad</p>
            </div>
          </div>
          <div class="col-md-4 text-center"> <a href="#" class="subscribe-button">Ir a facebook</a> </div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-offset-1 col-md-4 col-sm-offset-1 col-sm-5 col-xs-offset-1 col-xs-10">
          <div class="address">
            <h4>Dirección</h4>
            <p>Ciudad Quesada, Alajuela<br>
            <div class="email"><i class="fa fa-at"></i>ernesto@gmail.com<br>
              <i class="fa fa-mobile"></i>8516 8626
            </div>
            </p>
          </div>
        </div>
